        ...
        <div className="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
          ...
          <div className="mt-6 max-w-xl space-y-3 px-4 sm:px-0 md:mt-0 lg:max-w-2xl">
            ...
            <p className="mt-3 text-body-color dark:text-dark-6">
              {`At Talent Box, we specialize in sourcing exceptional healthcare professionals who embody your organization's values, ensuring seamless integration and exceptional patient care.`}
            </p>
            <a
              href="/healthcare"
