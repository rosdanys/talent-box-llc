  ...
  <div className="mx-auto max-w-screen-xl md:px-8">
    <div className="items-start gap-x-12 sm:px-4 md:px-0 lg:flex">
      ...
      <div className="mt-6 max-w-xl space-y-3 px-4 sm:px-0 md:mt-0 lg:max-w-2xl">
        <h3 className="font-semibold text-primary sm:mt-3 lg:mt-0">Culture</h3>
        ...
        <p className="mt-3 text-body-color dark:text-dark-6">
          ...
          and success. Our culture is built on the foundation of respect, empathy, and
          ...
          differences that we can truly thrive. We are committed to providing a supportive and
          empowering atmosphere where all voices are heard and valued. Through ongoing learning and
          development initiatives, we strive to cultivate a growth mindset that encourages
          continuous improvement and professional advancement for every team member. Transparency
          and integrity are at the core of everything we do. We believe in open communication,
          ...
          credibility in all our interactions. At Talent Box LLC, we are not just recruiters; we are
          partners in our clients' and candidates' success stories. We are passionate about making
          meaningful connections and matching the right talent with the right opportunities, driving
          positive change and impact in the world. Together, we are dedicated to creating a culture
          where everyone feels valued, empowered, and inspired to unleash their full potential. Join
