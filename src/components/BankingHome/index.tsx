        ...
        <div className="flex-1 sm:hidden lg:block">
          ...
          <div className="mt-6 max-w-xl space-y-3 px-4 sm:px-0 md:mt-0 lg:max-w-2xl">
            ...
            <p className="mt-3 text-body-color dark:text-dark-6">             
              <span className="my-2">{`Talent Box offers specialized expertise in navigating the complex recruitment landscape of the financial and professional services industry, ensuring access to top talent across diverse sectors.`}</span>
            </p>
            <a
              href="/banking"
